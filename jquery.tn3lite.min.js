...
h.cssID+"-"+q).remove()});var t=i('<div id="hide-this-shit" style="display:none;"></div>');t.css("position","absolute").width(1).height(1);t.appendTo(this.$c.find("."+h.cssID+"-gallery"));t.click(function(){window.location="http://tn3gallery.com"}).hover(function(){i(this).css("background-position","-258px -45px")},function(){i(this).css("background-position",
